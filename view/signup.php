...
<body>
    <div class="container text-center">
        <div class="row">
            <form action="/?controller=security&action=registration" method="post" class="sign-in-form mt-5 mt-md-5 col-lg-4 col-md-5 col-sm-8">
                <h3>Регистрация пользователя</h3>
                <div class="alert alert-danger <?=empty($errors) ? 'visually-hidden' : ''?>">
                    <ul>
